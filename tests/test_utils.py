...
def test_smart_pager_with_small_file(tmp_path: Path) -> None:
    """Test smart_pager with a small file (less than terminal height)."""
    ...
    with (
        ...
        with open(test_file) as f:
            ...
            mock_handle_file.assert_not_called()


def test_smart_pager_with_process() -> None:
    """Test smart_pager with a process."""
...
# Remove the test_smart_pager_with_string test since smart_pager doesn't handle strings